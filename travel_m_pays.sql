...
--
-- Client :  localhost
-- Généré le :  Mar 19 Août 2014 à 12:23
...
--
-- Base de données :  `travel_me`
--

-- --------------------------------------------------------

--
-- Structure de la table `travel_m_pays`
--

CREATE TABLE IF NOT EXISTS `travel_m_pays` (
...
--
-- Contenu de la table `travel_m_pays`
--

INSERT INTO `travel_m_pays` (`id`, `code`, `alpha2`, `alpha3`, `nom_en_gb`, `nom_fr_fr`) VALUES
